      ...
      <div class="relative">
        ...
        <div class="float-left w-7 h-7 leading-3">
          <button type="button" @click.prevent="togglePlay" >
            <i class="fa  text-xl"
            :class="{'fa-play text-gray-500' : !palying, 'fa-pause text-green-500' : palying}"
            ></i>
          </button>
        </div>
        <!-- Current Position -->
        ...
        >
          ...
          >
            ...
            <span class="song-artist">
                ارسال شده توسط : {{ currentSong.dispaly_name }}
            </span>
          </div>
          <!-- Scrub Container  -->
          <span  @click="updateSeek"
...
export default {
  ...
  methods: {
    ...mapActions(['updateSeek', 'togglePlay']),
  },
};
</script>
